...
def get_perf(filename, folder):
    ...
    _conlleval=folder + '/' + 'conlleval.pl'
    # print _conlleval
...
def main(param=None):
    ...
    folder=os.path.dirname(__file__)+'/'+folder_name
    ...
    for e in xrange(param['nepochs']):
        ...
        if res_valid['f1'] > best_f1:
            ...
            # replace the following unix style command with windows equivilent
            ...
            shutil.copyfile(folder+'/current.test.txt',folder+'/best.text.txt' )
            shutil.copyfile(folder+'/current.valid.txt',folder+'/best.valid.txt')
