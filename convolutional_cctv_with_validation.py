...
def evaluate_lenet5(datasets,learning_rate=0.01, d=0.00001, n_epochs=200,
...
if __name__ == '__main__':
    ...
    #
    # sss=StratifiedShuffleSplit(y, 3, test_size=0.25, random_state=0)
    #
    ...
    #     params=evaluate_lenet5(shared_dataset)
