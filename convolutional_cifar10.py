...
def create_shared_dataset(train_set, test_set, valid_set):
...
def evaluate_lenet5(datasets,learning_rate=0.01,  d=0.00001, n_epochs=500,
    ...
    # theano function to decay the learning rate across epoch
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                valid_error.append(this_validation_loss)
...
if __name__ == '__main__':
    ...
    # folder = os.path.dirname(__file__)
    folder="c:/users/xie/playground/CIFAR10_DeepLearning/"
    img_folder=folder+"/Data/"

    # Loading one image batch data
    train_pickle_file=img_folder+'train_data.pkl'
    labels_pickle_file=img_folder+'labels.pkl'

    img_data=numpy.array(load_pickle_data(train_pickle_file))
    img_labels=load_pickle_data(labels_pickle_file)
    # loading label meta data
    label_name_pickle_file=img_folder+'batches.meta'
    label_name=load_pickle_data(label_name_pickle_file)['label_names']

    # sss=StratifiedShuffleSplit(y, 10, test_size=0.25, random_state=0)


    train_x, train_y=img_data[0:30000], img_labels[0:30000]
    test_x, test_y = img_data[30000:40000], img_labels[30000:40000]
    valid_x, valid_y= img_data[40000:50000], img_labels[40000:50000]

    # train_x, train_y=img_data[0:20000], img_labels[0:20000]
    # test_x, test_y = img_data[20000:25000], img_labels[20000:25000]
    # valid_x, valid_y= img_data[25000:30000], img_labels[25000:30000]
    ...
    shared_dataset=create_shared_dataset(train_set, test_set, valid_set)
    params, valid_error=evaluate_lenet5(shared_dataset)

    plt.plot(valid_error)
    # model_path="./Model/cnn_2.pkl"
    # Save_Parameter(model_path, params)
    ...
    # params=evaluate_lenet5(data)

    # model_path="./model/LeNet5.dat"
    # Save_Parameter(model_path, params)
