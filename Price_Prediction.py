...
def xgb_learning_set_train_size(labels, train, test, num_rounds=1000, train_size=100):
    ...
    preds=xgb_learning(train_y, train, test)
...
def xgb_learning(labels, train, test, num_rounds=100):
    label_log = np.log1p(labels)

    # lpreds=linear_learning(labels,train,test)
...
def xgb_learning2(labels, train, test, num_rounds=100):
    label_log = np.log1p(labels)
